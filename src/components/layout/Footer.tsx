...
export default function Footer({
  logoText = 'Technovate',
  companyDescription = 'Pioneering the future of technology with innovative solutions, cutting-edge AI development, and transformative digital experiences. Trusted by Fortune 500 companies worldwide.',
  contactEmail = 'hello@technovate.com',
  contactPhone = '+1 (555) 847-2639',
  contactAddress = '2100 Innovation Drive, Tech Hub District',
  newsletterTitle = 'Tech Insights',
  newsletterDisclaimer = 'Get exclusive tech insights, product updates, and industry trends. Unsubscribe anytime.',
  section1Title = 'Solutions',
  section2Title = 'Company',
  section3Title = 'Resources',
  section4Title = 'Legal',
  copyrightText = '© 2024 Technovate. All rights reserved.',
  madeWithText = 'by our innovation team',
  socialText = 'Connect with us:',
  social1Href = 'https://twitter.com/technovate',
  social2Href = 'https://facebook.com/technovate',
  social3Href = 'https://instagram.com/technovate',
  social4Href = 'https://linkedin.com/company/technovate',
  social5Href = 'https://github.com/technovate',
}: FooterProps) {
  const footerSections = [
    {
      title: section1Title,
      links: [
        { name: 'AI Development', href: '/ai-solutions' },
        ...
        { name: 'Enterprise APIs', href: '/apis' },
      ],
    },
    {
      title: section2Title,
      links: [
        { name: 'About Technovate', href: '/about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Technical Docs', href: '/documentation' },
